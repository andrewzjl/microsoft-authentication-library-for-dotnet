...
{
    /// <summary>
    /// An abstraction over objects that are able to listen to localhost url (e.g. http://127.0.0.1:1234)
    /// and to retrieve the whole url, includiong query params (e.g. http://127.0.0.1:1234?code=auth_code_from_aad)
    /// </summary>
